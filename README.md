...
Вкладка **«Запуски»** проекта (вторая после «Файлов»; кнопка «▶ Запуски» в списке проектов ведёт туда же). Карточки идут по порядку:
...
Внутри проекта — вкладки: **Файлы, Запуски, Редактор, Глоссарий, Проверка, Главы, Статус, Конфиг, Промпты, Логи, Заметки**.
