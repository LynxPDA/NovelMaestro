# TODO — раунд 23: план (имена экспортов + «Файлы»: Файл/Каталог/Переим. + шаблоны-скелет + вкладка «Редактор» + .env-аудит)
...
- `core/projects.py:365 create_template_set` — **уже** создаёт `prompts/` + `source/` (раунд 22) ✅
