...
Статус: **готово**. Тултипы и единый стиль, варианты обложек/метаданных,
редизайн ner_check (чипсы/пресеты/степпер), очистка компиляции,
fallback заголовка главы — реализовано и покрыто тестами.
