        ...
        "fields": [
            ...
            {"name": "split_patterns",
             ...
             "help": "ТОЛЬКО режим regexp. Строка считается маркером, "
                      ...
                      "строки — « # …»; флаги (|i/|s) не поддерживаются; "
                      "пример: «Глава \\d+»; "
        ...
        "fields": [
            ...
            {"name": "regexp_checks",
             ...
             "help": "Каждая строка — regexp по тексту главы (multiline): "
                      ...
                      "комментарий в конце строки — « # …»; флаг в конце "
                      "строки « |s» — пропустить первое совпадение "
                      "(лишние заголовки «Глава N»: первое — сам "
                      "заголовок главы); пусто = дефолтные проверки "
                      "(иероглифы, латиница, лишние заголовки «Глава N» — "
                      "первое совпадение не ошибка); "
