        ...
        "fields": [
            ...
            {"name": "replace_patterns",
             ...
             "help": "Работают во ВСЕХ режимах, применяются ДО разбивки. "
                      ...
                      "текста»). «^»/«$» — начало/конец СТРОКИ; "
                      "флаги в конце строки: « |i» (регистр), "
                      "« |r» (regexp — всегда). Удобно "
                      "нормализовать маркеры глав: "
                      "«第(\\d+)章 -> Глава \\1» (\\1 — первая группа); "
                      "дубль заголовка главы: "
                      "«^(第\\d+章.*)\\n(?=\\1$) ->»; отступ строки: «^  ->». "
                      "Дубль заголовка в начале тела (повтор названия "
                      "главы первым абзацем) убирается автоматически "
                      "в режимах toc и regexp"}, 
            {"name": "title_limit",
