...
`chapters/00000_{N+1}_Wiki_Новеллы/` (`chapter.txt` + `polished.txt`),
название «Wiki Новеллы» простым текстом, статьи в rulate-стиле
(заголовки глубже). Компилятор: глава без «Глава N» берёт заголовок из
