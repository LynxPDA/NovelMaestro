...
- **Редактор** (W8): CodeMirror 6 (вендор в `static/vendor/`, офлайн):
  ...
  аналог `--ner_threshold`, дефолт 0.75, выше — строже), тултип с
  «→ Глоссарий» (предзаполненный поиск); настройки — localStorage
  браузера, не .env.
...
- **NER** (W5): таблица глоссария — инлайн-редактирование строк,
  ...
  добавление/удаление, поиск по всем столбцам; review-флоу:
