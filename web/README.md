...
- **NER** (W5): таблица глоссария — инлайн-редактирование строк,
  ...
  добавление/удаление, поиск слева (выбор полей кнопкой справа от поля;
  «Все поля» снимает/ставит все чекбоксы), фильтр типов теми же
  чекбоксами с числом записей; review-флоу:
