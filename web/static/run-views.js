        ...
        h(
          ...
          h(
            ...
            h("p", {}, "Каждая строка — regexp по тексту главы "
              ...
              + "строки включая заголовок; флаг в конце строки ",
              h("code", {}, " |s"), " — пропустить ПЕРВОЕ совпадение "
              + "(лишние заголовки «Глава N»: первое — сам заголовок, "
              + "не ошибка). Поле пусто — работают дефолтные проверки "
            ...
            h("p", {}, "Шпаргалка: ", h("code", {}, "^"), " — начало "
              ...
              h("code", {}, "(?<=\\n)паттерн"), " — всё, кроме вхождения "
                + "в самом начале файла (обход без |s: заголовок в "
                + "1-й строке не совпадёт)."),
            h("p", {}, "Комментарий в конце строки — ",
              h("code", {}, " # …"), "; пусто в поле = "
              + "дефолтные проверки. Флаги |i/|r из правил замен "
              + "(replacements.txt) здесь НЕ работают: из флагов — "
              + "только |s."),
          ),
        ),
      );
        ...
        h(
          ...
          h(
            ...
            h("p", {}, "Паттерны разбивки: строка-маркер = начало СТРОКИ "
              ...
              + "главы. Комментарий в конце строки — ",
              h("code", {}, " # …"), ". Флаги НЕ поддерживаются "
              + "(регистр значим)."),
            h("p", {}, "Regexp-замены: формат ", h("code", {}, "паттерн -> замена"),
              "; значимые пробелы — ", h("code", {}, "^  "), " и ",
              h("code", {}, "  $"), "; флаги в конце строки: ",
              h("code", {}, " |i"), " — без учёта регистра, ",
              h("code", {}, " |r"), " — всегда regexp (без эффекта)."),
