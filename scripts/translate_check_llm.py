...
PASS1_PROMPT = """\
Ты — профессиональный редактор перевода китайских веб-новелл на русский язык.
...
- artifact — китайские иероглифы, оставшиеся в тексте; западные единицы измерения (футы, мили) в китайском сеттинге; примечания переводчика в теле текста
