...
# ══════════════════════════════════════════════════════════════════════
DEFAULT_TRANSLATE_PROMPT = """=== ГЛОССАРИЙ ===
{ner_block}
=== КОНЕЦ ГЛОССАРИЯ ===
...
DEFAULT_TRANSLATE_LR_PROMPT = """=== СЛОВАРЬ ===
{dict_block}
=== КОНЕЦ СЛОВАРЯ ===
=== ПРАВИЛА ЯЗЫКА ===
{rules_block}
...
«=== ГЛОССАРИЙ ===»: словарь именованных сущностей (NER) в формате JSON. Поля: term, translation, type, aliases (если есть).
«=== ОРИГИНАЛ ===»: оригинальный текст на исходном языке.
«=== ЧЕРНОВОЙ ПЕРЕВОД ===»: черновой перевод на русский язык.
Task
Отредактируй текст из блока «Черновой перевод», опираясь на контекст оригинала и глоссария.
Editing Rules
...
Согласование: Проверь согласование всех слов. Если глоссарий указывает пол персонажа, все глаголы и прилагательные, относящиеся к нему, должны соответствовать этому полу.
Person (female) -> она пошла, она сказала.
Person (male) -> он пошел, он сказал.
Если пол не указан в словаре или указан с ошибкой, определи его по местоимениям (he/she) в оригинале.
Output Format
Верни ТОЛЬКО отредактированный текст в формате plain text (не добавляй форматирование markdown и другие, если такого форматирования не было в исходном тексте).
=== ГЛОССАРИЙ ===
{ner_block}
=== КОНЕЦ ГЛОССАРИЯ ===
=== ОРИГИНАЛ ===
